...
Once the `conda-forge` channel has been enabled, `shimmy, shimmy-all, shimmy-gym` can be installed with `conda`:

```
conda install shimmy shimmy-all shimmy-gym
```

or with `mamba`:

```
mamba install shimmy shimmy-all shimmy-gym
```
